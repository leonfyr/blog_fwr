...
文章的右侧会有一个可以跳转到对应部分的大纲。如果没有看到的话可以缩小页面试一下

由于有些文章是用中文写的，而有些是用英语写的。文章所使用的语言可以通过**文章的标题**辨别出

本博客每周三会更新这周所写的文章。这主要是因为 Netlify 免费版每个月只有**300 credits**, 而上传一次就要消耗 **15** 个credits /(ㄒoㄒ)/~~
