...
export const siteConfig: SiteConfig = {
	...
	favicon: [
		...
		{
			src: "/favicon/avatar_circle.png", // Path of the favicon, relative to the /public directory
...
export const profileConfig: ProfileConfig = {
	...
	links: [
		...
		// },
		{
			...
			url: "https://github.com/leonfyr",
		},
		{
			name: "Bilibili",
			icon: "fa6-brands:bilibili",
			url: "https://space.bilibili.com/490356972",
		},
		{
			name: "Mail",
...
export const commentConfig: CommentConfig = {
  twikoo: {
    envId: 'https://comment.haoye.plus/.netlify/functions/twikoo',
  },
}
